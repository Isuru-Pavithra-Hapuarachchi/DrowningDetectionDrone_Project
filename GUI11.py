...
model = torch.hub.load('ultralytics/yolov5', 'custom', path=r'C:\Project\Project\DrowningDetectionDrone\Drowning Detection Drone\yolov5\runs\train\exp5\weights\best.pt')
